...
use Utils\GatewayWorker\Protocols\GatewayProtocol;
...
class BusinessWorker extends Worker
{
    ...
    protected function onWorkerStart()
    {
        ...
        {
            class_alias('\Utils\GatewayWorker\Protocols\GatewayProtocol', 'Protocols\GatewayProtocol');
        }
        Timer::add(1, array($this, 'checkGatewayConnections'));
        $this->checkGatewayConnections();
        \Utils\GatewayWorker\Lib\Gateway::setBusinessWorker($this);
